...
<form action="./index.php" method="post" id="formSendMessages" name="formSendMessages">
<input type="hidden" name="m" value="({$module_name})" />
...
<form action="./index.php" method="post" name="formSendMessagesSearch">
<input type="hidden" name="m" value="({$module_name})" />
<input type="hidden" name="sessid" value="({$PHPSESSID})" />
({if $cond})
...
<form action="./index.php" method="post" name="formSendMessagesAll">
<input type="hidden" name="m" value="({$module_name})" />
<input type="hidden" name="a" value="page_({$hash_tbl->hash('send_messages_all')})" />
<input type="hidden" name="sessid" value="({$PHPSESSID})" />
...
<form action="./index.php" method="get" name="formSendMessagesIDList">
<input type="hidden" name="m" value="({$module_name})">
...
<form action="./index.php" method="post" name="formSendMessagesHistory">
<input type="hidden" name="m" value="({$module_name})">
